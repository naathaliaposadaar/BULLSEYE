...
<div class="row">
  ...
  <div class="col-md-4">
      <a type="button" id="btnIngresarEmpresa"  href="insertarEmpresa.php" class="btn btn-warning "  style="width: 250px;"><span class="glyphicon glyphicon-hand-down"><span id="spanBuscar">   Inscribe tu Empresa Aquí</span> </span></a> 
  </div>
  <div>
